...
class MetricPlotter:
    ...
    def plot_feature(self, feature, figsize=None,
        ...
        for key in self.SIZE_KEYS:
            print("primo loop")
            print(self.PROCESSED_FEATURES[key]) # there are no features
            has_size = False
...
test = MetricPlotter()
print(test.search_for_qasm())
print(test.format_circuit_name("qft.qasm")) # output: Qft.Qasm
print(test.format_feature_name(feature="LARGE")) # output: Large
print(test.load_next_qasm_to_circuit())
print(test.max_of_feature(feature="LARGE")) # output: -1
print(test.load_next_qasm()) # <generator object MetricPlotter.load_next_qasm at 0x7ff096a64740>
print(test.process_qasm_files) 
print(test.evaluate_qasm(qasm='''OPENQASM 2.0;include "qelib1.inc";qreg q[2];creg c[2];reset q[0];h q[0];reset q[1];cx q[0],q[1];h q[0];h q[1];measure q[0] -> c[0];measure q[1] -> c[1];''')) # output: <function MetricPlotter.evaluate_qasm at 0x7fe478176170>
print(test.process_qasm_files) # output: <bound method MetricPlotter.process_qasm_files of <__main__.MetricPlotter object at 0x7fd17aa60340>>    
print(test.plot_feature)
test.plot_feature(feature="LARGE")
print(test.plot_feature(feature="LARGE")) # error
print(test.QASMBENCH_KEYS)